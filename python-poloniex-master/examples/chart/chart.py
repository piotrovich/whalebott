...
if __name__ == '__main__':
    ...
    handler = logging.handlers.TimedRotatingFileHandler(filename='examples/chart/logs/Chart.log', when="h", interval=8,
                                                        backupCount=50)
    #HANDLER PARA PYCHARM
    #handler = logging.handlers.TimedRotatingFileHandler(filename='logs/Chart.log', when="h", interval=16,
    #                                                    backupCount=50)
